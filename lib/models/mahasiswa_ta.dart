...
class MahasiswaTA extends ConsumerWidget {
  List<dynamic>? dibimbing;
  List<dynamic>? diuji;

  MahasiswaTA({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final userData = ref.read(storageProvider);
    dibimbing =
        userData['dibimbing'].where((mhs) => mhs['kategori'] == 'ta').toList();
    diuji = userData['diuji'].where((mhs) => mhs['kategori'] == 'ta').toList();
